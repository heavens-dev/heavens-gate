...
def test_disable_peer(wg_hub: WGHub, default_peers: dict[str, ConnectionPeer]):
...
def test_enable_peer(wg_hub: WGHub, default_peers: dict[str, ConnectionPeer]):
...
def test_add_peer(wg_hub: WGHub, default_peers: dict[str, ConnectionPeer]):
...
def test_delete_peer(wg_hub: WGHub, default_peers: dict[str, ConnectionPeer]):
