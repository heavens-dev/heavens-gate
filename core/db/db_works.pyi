...
class Client(BaseModel):
    ...
    def add_xray_peer(self, flow: str, inbound_id: int, peer_name: Optional[str] = None) -> Optional[XrayPeer]: ...
    ...
    def set_subscription_expiry(self, expire_date: datetime.datetime) -> bool: ...
    ...
    def set_peer_active_time(self, peer_id: int, time: datetime.datetime) -> None: ...
...
class ClientFactory(BaseModel):
    ...
    @staticmethod
    def get_peer_by_id(peer_id: int, protocol_specific: bool = False) \
        -> Optional[Union[BasePeer, WireguardPeer, XrayPeer]]: ...
    @staticmethod
    def get_peer_by_ip(ip_address: str) -> Optional[WireguardPeer]: ...
    @staticmethod
    def get_wireguard_peer(ip_address: str) -> Optional[WireguardPeer]: ...
    @staticmethod
    def get_xray_peer(peer_id: int) -> Optional[XrayPeer]: ...
